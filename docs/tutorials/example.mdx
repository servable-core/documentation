...
This is to enforce the unique ability of Servable to predict schema and apply it additively at every boot, checked against a committed artifact for drift and a compatibility floor, thus avoiding environment discrepancies.
